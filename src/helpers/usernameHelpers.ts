...
export function initUsernameHandlers(startGameButton: HTMLElement, joinGameButton: HTMLElement) {
  const usernameInput = querySelector<HTMLInputElement>('input[name="username"]')
  const saveUsernameButton = querySelector('.save-username')
